  ...
  switch (name) {
    ...
    case 'products':
      return (
        ...
        >
          <path
            d="M8.729 5.636V2.394h.576a.576.576 0 0 0 0-1.152H4.699a.576.576 0 0 0 0 1.152h.575v3.242l-3.009 4.422c-.78 1.147.041 2.7 1.428 2.7h6.617c1.388 0 2.209-1.553 1.428-2.7L8.729 5.637v-.001Z"
            fill="#DCDDDF"
          />
        </svg>
      );
    case 'customers':
      return (
        ...
        >
          <g clipPath="url(#a)">
            <path
              d="M9.303 8.151H7.576V9.88H6.424V8.15H4.697V7h1.727V5.273h1.152V7h1.727m2.879-4.03h-1.526l.662-1.814-1.353-.49-.84 2.304H1.818V4.12L2.97 7.576 1.818 11.03v1.152h10.364V11.03L11.03 7.576l1.152-3.455V2.97Z"
              fill="#DCDDDF"
            />
          </g>
          <defs>
